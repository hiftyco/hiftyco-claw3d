...
export const TRADING_ROOM_MIGRATION_KEY = "openclaw-office-trading-room-migration-v1";
...
export const TRADING_ROOM_X = QA_LAB_END_X + EAST_HALL_WIDTH;
export const TRADING_ROOM_WIDTH = EAST_WING_SPECIALTY_ROOM_WIDTH;
export const TRADING_ROOM_END_X = TRADING_ROOM_X + TRADING_ROOM_WIDTH;
